...
---------------------------------
	...
	LOST 'projectsMapping.json' 
		DONT PAN!C 
		  create a file named projectsMapping.json inside 'dartabase_migration/bin/'
...
------------------------
    ...
    1.Execute dartabase_migration/bin/dbDown.dart to execute the dartabase_migration 
      actions you specified inside the "DOWN" key.
